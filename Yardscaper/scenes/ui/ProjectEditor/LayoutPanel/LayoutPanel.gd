...
func _on_TheProject_opened():
	...
	Utils.set_item_checked_by_id(pipe_view_popupmenu, PipeViewMenuIds.ShowFittings, prefs.show_pipe_fittings)
...
func _on_pipe_view_popup_menu_id_pressed(id: int) -> void:
	...
	match id:
		...
		PipeViewMenuIds.ShowFittings:
			TheProject.pref.show_pipe_fittings = is_checked
